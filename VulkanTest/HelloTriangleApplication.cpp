...
void HelloTriangleApplication::initWindow()
{
	...
	//REsizable window needs special attention
...
{
	//Create an instance to connect vulkan library to application
	createInstance();
	//Enable Validation Layers
	setupDebugMessenger();
	//Create windows surface
	createSurface();
	//Find supported GPU device
	pickPhysicalDevice();
	//Create logical device
	createLogicalDevice();
	//create Swap chain
	createSwapChain();
	//Create the views for image to load
	createImageViews();
	//Create render information pass
	createRenderPass();
...
{
	//Loops and check for event such as use pressing X button
...
void HelloTriangleApplication::createInstance()
{
	...
	//Some information about the application (optional)
	...
	//Check for extension support before creating the instance
...
void HelloTriangleApplication::createLogicalDevice()
{
	...
	//No device features used as of such
	VkPhysicalDeviceFeatures deviceFeatures{}; 

	//Logical Device Struct
...
{
	SwapChainSupportDetails swapChainSupport = querySwapChainSupport(physicalDevice, this->surface);
...
{
	QueueFamilyIndices queueFamilyIndices =	findQueueFamilies(physicalDevice, this->surface);
...
std::vector<char> readFile(const std::string& filename)
{
	...
	file.close();
	std::cout << buffer.size() << " file shader" << std::endl;
	return buffer;
}
